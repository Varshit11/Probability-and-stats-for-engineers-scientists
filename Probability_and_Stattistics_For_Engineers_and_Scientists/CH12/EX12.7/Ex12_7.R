...
# Chapter 12
# Example 12.7 Page no. 458 from the pdf..
...
c <- lm(y~x1+x2+x3,data= dat)  #modelling the variables of datasaet..


newdat <- data.frame(x1=3,x2=8,x3=9)

d <- predict(c,newdat,interval = "prediction")

cat("The 95% prediction interval for the individual response when x1=3%,x2=8% and x3=9% is",d[2],d[3])
